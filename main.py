...
player_image_R = pg.image.load('C:/MyFiles/pyproj/pygame_env/NYPS/NYPS GEP Harmony/Shen_Zeyou/marioR.png')
player_image_L = pg.image.load('C:/MyFiles/pyproj/pygame_env/NYPS/NYPS GEP Harmony/Shen_Zeyou/marioL.png')
...
obj_size = 60
obj_data = [] 
obj = pg.image.load('C:/MyFiles/pyproj/pygame_env/NYPS/NYPS GEP Harmony/Shen_Zeyou/e1.png')
obj = pg.transform.scale(obj, (obj_size, obj_size))


heart_size = 60
heart_data = [] 
heart = pg.image.load('C:/MyFiles/pyproj/pygame_env/NYPS/NYPS GEP Harmony/Shen_Zeyou/heart.png')
heart = pg.transform.scale(heart, (heart_size, heart_size))

bg_image = pg.image.load('C:/MyFiles/pyproj/pygame_env/NYPS/NYPS GEP Harmony/Shen_Zeyou/background.png')
